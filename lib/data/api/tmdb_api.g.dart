...
class _TMDBApi implements TMDBApi {
  ...
  @override
  Future<MovieListResponse> getNowPlayingMovies(String apiKey) async {
    const _extra = <String, dynamic>{};
  ...
  @override
  Future<MovieListResponse> getTopRatedMovies(String apiKey) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'api_key': apiKey};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<MovieListResponse> getPopularMovies(String apiKey) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'api_key': apiKey};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<MovieListResponse> getUpcomingMovies(String apiKey) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'api_key': apiKey};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  Future<MovieVideosResponse> getMovieVideos(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<MovieVideosResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<TvShowListResponse> getTrendingTVShows(String apiKey) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'api_key': apiKey};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<TvShowListResponse>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = TvShowListResponse.fromJson(_result.data!);
    return value;
  }

  @override
  Future<TvShowListResponse> getPopularTVShows(String apiKey) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'api_key': apiKey};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
  ...
  @override
  Future<TvShowListResponse> getTopRatedTVShows(String apiKey) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'api_key': apiKey};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
